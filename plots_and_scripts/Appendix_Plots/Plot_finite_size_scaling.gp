...
set xtics ('\fontsize{10}{10} $\frac{1}{4}$' 0.25,'\fontsize{10}{10} $\frac{1}{6}$' 0.166667,'\fontsize{10}{10} $\frac{1}{8}$' 0.125,'\fontsize{10}{10} $\frac{1}{16}$' 0.0625, '\fontsize{10}{10} $\frac{1}{32}$' 0.03125, '\fontsize{10}{10} $\frac{1}{64}$' 0.015625,'\fontsize{10}{10} $\frac{1}{128}$' 0.0078125) offset 0,0.2
...
set logscale x
set key samplen 1 spacing 1.5 at 0.0325,0.125

plot "../Data_Files/Auc_vs_1byLx_for_m1.75_U0.0.txt" u 2:(abs(($3))) w lp lw 2 lt 1 ps 1 pt 7 lc rgb '#34495e' ti '\fontsize{7}{7}\selectfont$U=0.0$',"../Data_Files/Auc_vs_1byLx_for_m1.75_U1.0.txt" u 2:(abs(($3))) w lp lw 2 ps 1.1 pt 5 lc rgb '#e74c3c' ti '\fontsize{7}{7}\selectfont$U=1.0$'

#,"../Data_Files/Auc_vs_1byLx_for_m1.75_U5.0.txt" u 2:(abs(($3))) w lp lw 2 ps 1.1 pt 5 lc rgb '#f39c12' ti '\fontsize{7}{7}\selectfont$U=5.0$'
