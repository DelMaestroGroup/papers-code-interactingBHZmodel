...
set output 'Bulk_Edge_moments_and_occupation_for_m1p75_4x4.tex'
...
set label 1 at 6.0,-0.06 '\fontsize{7}{7} $\sum_{i \in edge}\langle \tilde{n}_{i,0}\rangle/N_e$' tc rgb 'brown'
set label 2 at 6.0,-0.11 '\fontsize{7}{7} $\left[\langle S^2_{edge}\rangle-\langle S^2_{bulk}\rangle\right]$' tc rgb 'black' 

set key samplen 1.5 spacing 1.0 at 11.25,-0.02
set xzeroaxis lw 3 lt 1 dt 3 lc rgb 'black'

set label 3 at 9.0,0.16 '\fontsize{7}{7}\selectfont$m=1.75$'
set object rect from 0.0,-0.18 to 4.35,0.18 fs solid 0.25 noborder fc rgb "red" behind
set object rect from 4.35,-0.18 to 5.5,0.18 fs solid 0.25 noborder fc rgb "blue" behind


plot "../Data_Files/Edge_minus_Bulk_occupation_for_orb0_vs_U_m1.75.txt" u 1:2 w lp lw 2.5 lt 1 ps 0.7 pt 7 lc rgb 'brown' ti '',"../Data_Files/Bulk-Edge_spin_observes_m1.75.txt" u 1:($2)-($3) w lp lw 2.5 lt 1 dt 3 ps 0.7 pt 6 lc rgb 'black' ti ''
