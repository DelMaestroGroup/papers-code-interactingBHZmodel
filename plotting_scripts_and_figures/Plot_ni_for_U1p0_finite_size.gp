...
set x2tics('\fontsize{8}{8} \selectfont$0$' 4, '\fontsize{8}{8} \selectfont$4$' 8, '\fontsize{8}{8} \selectfont$8$' 12,'\fontsize{8}{8} \selectfont$12$' 16, '\fontsize{8}{8} \selectfont$16$' 20) tc rgb '#DE3163'  offset -0.1,-0.6
...
set key samplen 1 spacing 0.75 at 15.5,-0.06
set xzeroaxis lw 3 lt 1 dt 3 lc rgb 'black'

plot "Data_Files/ni_vs_i_orb0_U1.0_m1.75_4x4.txt" u (($1)+4):2 w lp lw 3 lt 1 dt 3 ps 1.0 pt 6 lc rgb 'red' ti '\fontsize{6}{6}\selectfont $\alpha=s$, $4\times 4$',"Data_Files/ni_vs_i_orb1_U1.0_m1.75_4x4.txt" u (($1)+4):2 w lp lw 3 lt 1 dt 3 ps 1.0 pt 4 lc rgb 'blue' ti '\fontsize{6}{6}\selectfont $\alpha=p$, $4\times 4$', "Data_Files/ni_vs_i_orb0_U1.0_m1.75_6x4.txt" u 1:2 w lp lw 3 lt 1 ps 1.0 pt 7 lc rgb 'red' ti '\fontsize{6}{6}\selectfont $\alpha=s$, $6\times 4$',"Data_Files/ni_vs_i_orb1_U1.0_m1.75_6x4.txt" u 1:2 w lp lw 3 lt 1 ps 1.0 pt 5 lc rgb 'blue' ti '\fontsize{6}{6}\selectfont $\alpha=p$, $6\times 4$'
