set terminal epslatex size 5,4.5 standalone color colortext 8
...
set ylabel '\fontsize{12}{12}\selectfont$\langle n_{\alpha}\rangle$' offset 7.5,0
set xlabel '\fontsize{10}{10}\selectfont$U$' offset 0
set key samplen 1 spacing 1.5 at 4.25,1.2

set label 1 at 10.8,1.9 '\scalebox{1.25}{(a)}'
set label 2 at 0.1,1.85 '\fontsize{10}{10}\selectfont$(0,2)$'
set label 3 at 10,1.1 '\fontsize{10}{10}\selectfont$(1,1)$'
set label 4 at 2,0.5 '\fontsize{10}{10}\selectfont$BI$'
set label 5 at 10,0.5 '\fontsize{10}{10}\selectfont$MI$'
...
plot "Data_Files/Local_charge_observes_m3.0.txt" u 1:2 w lp lw 2.0 lt 1 ps 1.0 pt 7 lc rgb 'red' ti '\fontsize{10}{10}\selectfont$\alpha=s$', "Data_Files/Local_charge_observes_m3.0.txt" u 1:3 w lp lw 2.0 lt 1 ps 1.0 pt 5 lc rgb 'blue' ti '\fontsize{10}{10}\selectfont$\alpha=p$'
...
set ylabel '\fontsize{12}{12}\selectfont$\langle S^{2}_{\alpha}\rangle$' offset 7.5,0
set xlabel '\fontsize{10}{10}\selectfont$U$' offset 0
set key spacing 1.5 at 4.25,1.6

set label 1 at 0.1,1.9 '\scalebox{1.25}{(b)}'
set label 2 at 2.0,0.5 '\fontsize{10}{10}\selectfont$NM$'
set label 3 at 6.5,1.5 '\fontsize{10}{10}\selectfont$PM$'

#set label 4 at 9.5,0.875 '\fontsize{10}{10}\selectfont$(1,1)$'
#set label 5 at 9.5,0.3 '\fontsize{10}{10}\selectfont$MI$'

set arrow nohead from 0.1,0.75 to 10.0,0.75 lt 1 dt 6 lw 3 lc rgb 'gray'

plot "Data_Files/Local_spin_observes_m3.0.txt" u 1:2 w lp lw 2.0 lt 1 pt 7 ps 1.0 lc rgb 'red' ti '\fontsize{10}{10}\selectfont$s$', "Data_Files/Local_spin_observes_m3.0.txt" u 1:3 w lp lw 2.5 lt 0 ps 1.0 pt 5 lc rgb 'blue' ti '\fontsize{10}{10}\selectfont$p$', "Data_Files/Local_spin_observes_m3.0.txt" u 1:4 w lp lw 2.0 lt 1 ps 1.0 pt 7 lc rgb 'orange' ti '\fontsize{10}{10}\selectfont$tot.$'
...
set xlabel '\fontsize{10}{10}\selectfont$U$' offset 0
set ylabel '\fontsize{12}{12}\selectfont$ S(\mathbf{q})$' offset 7.5,0

set key horizontal spacing 1.5 at 5.2,0.9

set label 1 at 0.1,0.95 '\scalebox{1.25}{(c)}'
set label 2 at 2,0.3 '\fontsize{10}{10}\selectfont$NM$'
set label 3 at 6.5,0.5 '\fontsize{10}{10}\selectfont$PM$'
set label 4 at 9.5,0.3 '\fontsize{10}{10}\selectfont$AFM$'

set arrow nohead from 6.0,0.0 to 6.0,1.0 lt 1 dt 6 lw 3 lc rgb 'black'
set arrow nohead from 8.5,0.0 to 8.5,1.0 lt 1 dt 6 lw 3 lc rgb 'black'

plot "Data_Files/Sq_vs_U_observes_m3.0.txt" u 1:2 w lp lw 2.0 lt 1 ps 1.0 pt 7 lc rgb 'purple' ti '\fontsize{10}{10}\selectfont$ S(0,0) $', "Data_Files/Sq_vs_U_observes_m3.0.txt" u 1:3 w lp lw 2.0 lt 1 ps 1.0 pt 7 lc rgb 'dark-green' ti '\fontsize{10}{10}\selectfont$ S(0,\pi) $', "Data_Files/Sq_vs_U_observes_m3.0.txt" u 1:4 w lp lw 2.0 lt 1 ps 1.0 pt 7 lc rgb 'magenta' ti '\fontsize{10}{10}\selectfont$ S(\pi,0) $',  "Data_Files/Sq_vs_U_observes_m3.0.txt" u 1:5 w lp lw 2.0 lt 1 ps 1.0 pt 7 lc rgb 'brown' ti '\fontsize{10}{10}\selectfont$ S(\pi,\pi) $'
...
set ylabel '\fontsize{12}{12} $S(d)$' offset 8.7,0
set xlabel '\fontsize{12}{12}\selectfont$d$' offset 0
set key horizontal samplen 1 spacing 1 width -2.5 at 6,0.99

set xzeroaxis lw 3 lt 1 dt 3 lc rgb 'black'
set label 1 at 0.4,0.95 '\scalebox{1.25}{(d)}'

plot "Data_Files/Sd_corr_vs_d_tot_U1.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#ccccff' ti '\fontsize{8}{8}\selectfont$ U=1.0 $',"Data_Files/Sd_corr_vs_d_tot_U3.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#8e44ad' ti '\fontsize{8}{8}\selectfont$ U=3.0 $',"Data_Files/Sd_corr_vs_d_tot_U5.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#d4ac0d' ti '\fontsize{8}{8}\selectfont$ U=5.0 $',"Data_Files/Sd_corr_vs_d_tot_U7.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb 'black' ti '\fontsize{8}{8}\selectfont$ U=7.0 $',"Data_Files/Sd_corr_vs_d_tot_U8.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#3498db' ti '\fontsize{8}{8}\selectfont$ U=8.0 $',"Data_Files/Sd_corr_vs_d_tot_U9.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#2ecc71' ti '\fontsize{8}{8}\selectfont$ U=9.0 $',"Data_Files/Sd_corr_vs_d_tot_U10.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#d35400' ti '\fontsize{8}{8}\selectfont$ U=10.0 $',"Data_Files/Sd_corr_vs_d_tot_U12.0_m3.0_4x4.txt" u 1:2 w lp lw 2.0 lt 1 ps 0.8 pt 7 lc rgb '#34495e' ti '\fontsize{8}{8}\selectfont$ U=12.0 $'
